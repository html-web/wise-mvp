 ...
 * content without hard‑coding it into the HTML.
 */
...
document.addEventListener('DOMContentLoaded', async () => {
  try {
    ...
    /**
     * Helper to create a section with a heading and either a paragraph or a list.
     *
     * @param {string} headingText The heading for the section
     * @param {string|string[]} body The content for the section; if it’s an
     * array a list is rendered, otherwise a paragraph is used
     * @returns {HTMLElement}
     */
    ...
    // Construct and append sections in the desired order. Each property on
    // `data` corresponds to a topic in the MVP summary. Should a new
    // property be added to the API response, it can be inserted here.
